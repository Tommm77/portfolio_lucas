...
import RadialGradient from "@/app/components/magicui/radial-gradient";
    ...
    return (
        <Section className="relative">
            <div className="flex flex-col items-center justify-center mt-20">
                ...
                <AnimatedGradientText>
                    <span
                        className="animate-gradient bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent text-8xl text-center h-32 -mt-10">CyberSecurity Engineer</span>
                </AnimatedGradientText>

                <p className="w-1/3 font-semibold text-center text-lg mb-5">Hi 👋. My name is Lucas, and I am a
                    cybersecurity engineer living in Paris & working remotely with the whole world.
                </p>
