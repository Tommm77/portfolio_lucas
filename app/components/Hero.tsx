    ...
    return (
        <Section>
            <div className="flex flex-col items-center justify-center mt-20">
                ...
                <p className="w-1/3 font-semibold text-center text-lg mb-5">Hi 👋. My name is Lucas, and I am a cybersecurity engineer living in Paris & working remotely with the whole world.
                </p>
